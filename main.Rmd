...
knit: (function(input, ...) {
    rmarkdown::render(
      input,
      output_file = paste0(
        xfun::sans_ext(input), '-comments.html'
      ),
      envir = globalenv()
    )
  })
...
**Powtórzona analiza w modelu dominującym dla SNP z bardzo małą liczbą homozygot (n <= 6)**
...
**Uwzględniono wartość początkową jako dodatkową zmienną niezależną**
